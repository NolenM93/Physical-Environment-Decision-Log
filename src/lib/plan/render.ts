...
export const STUDIO_THEME: PlanTheme = {
  ...
  wall: '#152036',
  wallWidth: 3,
  gridMinor: 'rgba(21,32,54,0.06)',
  gridMajor: 'rgba(21,32,54,0.12)',
  item: 'rgba(21,32,54,0.05)',
  itemStroke: '#5c564c',
  itemLabel: '#3a362f',
  selection: '#8d6e38',
  dimension: '#6f675c',
  ...
  window: '#3d5a78',
  outlet: '#8d6e38',
  findingBlocker: '#a33d36',
  findingWarning: '#9a6f28',
  findingNote: '#3d5a78',
  ghost: 'rgba(141,110,56,0.28)',
  sun: 'rgba(196,165,110,0.22)',
};
